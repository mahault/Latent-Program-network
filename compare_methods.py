...
from lpn_model import LatentProgramNetwork, ListOpsDataset
...
def main():
    ...
    parser.add_argument('--baseline_model', type=str, default='best_lpn_model.pt')
    parser.add_argument('--poe_model', type=str, default='best_poe_model.pt')
