...
class ARCDataset(Dataset):
    ...
    def __init__(self, data_dir: str = './data/arc_data', split: str = 'training',
...
if __name__ == "__main__":
    ...
    dataset = ARCDataset(data_dir='./data/arc_data', split='training', download=False)
