...
from src.models.spatial_model import SpatialLPN, compute_spatial_loss
...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='./data/synthetic_grid_data')
    ...
    for epoch in range(args.num_epochs):
        ...
        if val_metrics['accuracy'] > best_val_acc:
            ...
            torch.save(model.state_dict(), 'results/models/best_spatial_model.pt')
            print(f"✓ Saved best model (acc: {best_val_acc:.4f})")
    
    # Save history
    with open('results/metrics/spatial_training_history.json', 'w') as f:
